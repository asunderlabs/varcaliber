...
class SendAccountBalance extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'account:sendBalance';
     ...
     * @var string
     */
    protected $description = 'Send account balance emails.';
    ...
    public function handle(): void
    {
        ...
        foreach (User::whereNotNull('preferences')->where('preferences->account_notification_email', true)->get() as $user) {
            ...
            foreach ($user->organizations as $organization) {
                if ($organization->billTotal()) {
                    $user->sendAccountBalanceNotification($organization);
                }
            }
        }
    }
