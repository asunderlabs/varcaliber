<template>
    ...
    <BreezeAuthenticatedLayout :isAdmin="true">
        ...
        <div class="bg-white px-4 md:px-6 py-3">
            <PageSection header="Create Work Entry">
...
export default {
    ...
    mounted() {
        this.form.startDate = new dayjs().format('YYYY-MM-DD')
        this.form.startTime = new dayjs().format('HH:mm')
        this.form.endDate = new dayjs().format('YYYY-MM-DD')
        this.form.endTime = new dayjs().format('HH:mm')
    },

    methods: {
        onSubmit(e) {
            console.log(this.form)
            this.$inertia.post("/admin/hours", this.form)
        },
